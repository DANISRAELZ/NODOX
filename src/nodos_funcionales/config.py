...
DEFAULT_CONFIG = {
    ...
    "online_sources": {
        ...
        "deg": {
            ...
            "provider_base_url": "https://tubic.org/deg/public/index.php/download",
            "provider_download_url": "https://tubic.org/deg/public/download/deg_annotation_p.csv.zip",
            "local_dataset_path": "data_external/deg.csv",
            "local_dataset_version_path": "data_external/deg.version.txt",
            "provider_timeout_seconds": 15,
            "provider_max_retries": 1,
            "provider_backoff_seconds": 1.0,
        ...
        "vfdb": {
            ...
            "access_mode": "local_dataset",
            "provider_base_url": "https://www.mgc.ac.cn/VFs/",
            "local_dataset_path": "data_external/vfdb.csv",
            "local_dataset_version_path": "data_external/vfdb.version.txt",
        ...
        "bvbrc": {
            ...
            "genome_query_limit": 10000,
            "feature_query_limit": 50000,
            "feature_page_size": 25000,
            "max_candidate_genes": 50,
