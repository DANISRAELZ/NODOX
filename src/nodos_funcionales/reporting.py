...
def export_results(base_dir: Path, config: dict, mode: str = "compare") -> None:
    ...
    report_lines = [
        ...
        *_metadata_lines(workspace_metadata),
        ...
        "- `therapeutic_priority_score` prioriza hipotesis dentro del modelo; `evidence_confidence_score` describe el soporte disponible para interpretarlas.",
        ...
        "- Lectura conservadora: proxy, baja confianza, redundancia alta, `paralog_count` alto, `mobile_context`, `hgt_context`, `recombination_context` o `resistance_association` deben penalizar la conclusion o quedar advertidos.",
        "- La subcapa evolutiva modula robustez y escape sin opacar funcionalidad, selectividad, accesibilidad ni evidencia trazable.",
        *theory_v3_report_lines,
        "",
        "## Resumen",
