...
>
> **Theoretical model status:** The theoretical model underlying NODOX remains under active review by our project collaborators. Its concepts, assumptions, variables, and scoring interpretation should be considered provisional and may change as that review progresses. Passing software tests confirms implementation consistency and reproducibility; it does not constitute scientific validation of the theoretical model.
